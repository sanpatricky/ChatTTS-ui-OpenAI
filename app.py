...
from uilib.utils import is_chinese_os
...
def generate_speech():
    ...
    skip_refine = defaults["skip_refine"]
    speed = defaults["speed"]
    text_seed = defaults["text_seed"]
    refine_max_new_token = defaults["refine_max_new_token"]
    infer_max_new_token = defaults["infer_max_new_token"]
